...
*/
int MOTOR_FrontL_PIN = 10;//PWML7 = pin 6
int MOTOR_FrontR_PIN = 11;//PWML6 = pin 7
int MOTOR_BackL_PIN = 5;// PWML5 = pin 8
...
void motor_command() 
{
  ...
  PWMC_SetDutyCycle(PWM, MOTOR_BackL_PIN, motor_BackL);//9 = PWML4
  analogWrite(MOTOR_FrontL_PIN, motor_FrontL);
...
void motor_Mix(){
      if((CH_THRf - 1500) > 0){
        motor_FrontL = (CH_THRf - 1500)*0.45;
      }
      else{
        motor_FrontR = (CH_THRf - 1500)*-0.45;
      }
      motor_BackL = CH_AILf;//Back L
...
*/
       if (CH_THR < MINTHROTTLE)
        ...
        {
         //motor_Lag();
         motor_FrontL = constrain(motor_FrontL, 0, 255);//set PWM data (1000 - 2000)*2 to (2000 - 4000)
         motor_FrontR = constrain(motor_FrontR, 0, 255);
         motor_BackL = constrain(motor_BackL, MINTHROTTLE, MAXCOMMAND);
         //motor_BackRf = constrain(motor_BackR, MINTHROTTLE, MAXCOMMAND);
        }
        else
        {
          motor_FrontL = 0;//set PWM data (1000 - 2000)*2 to (2000 - 4000)
          motor_FrontR = 0;
          //motor_BackLf = 1000;
          //motor_BackRf = 1000;
        }
