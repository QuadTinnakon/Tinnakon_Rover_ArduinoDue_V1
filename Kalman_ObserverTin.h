...
//u_z = accrZ_Earth*1.15;//applyDeadband = 0.1 m/s^2  = ,,(u - c*z2_hat)/m = Accz
...
//z2_hat = z2_hat2 + 0.012502*(Altitude_Baro_ult - z1_hat2) + 0.0001541023*(Vz_Baro_ult - z2_hat2);//K2 = 0.0002141023, 0.0001641, 0.00145, 0.00045,,,k2 0.097502,  0.065502, 0.009
//z1_hat = z1_hat2 + 0.015102*(Altitude_Baro_ult - z1_hat2) + 0.0001041023*(Vz_Baro_ult - z2_hat2);//K1 =0.035102, 0.015102 0.065 0.2887  0.09187 0.01187 0.0140
}
